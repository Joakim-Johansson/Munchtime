  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
        stream: FirebaseFirestore.instance
            .collection("Recipes")
            .where("user", isEqualTo: userDoc.id)
            .snapshots(),
          ...
          if (snapshot.hasData) {
            if (snapshot.data!.docs.length > 0) {
              ...
              snapshot.data!.docs.forEach((element) {
                ...
                totalgrade = totalgrade + int.parse(element["Climate Grade"][0]);
              });

              climateGrade = (totalgrade ~/ snapshot.data!.docs.length);
            }
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: CircleAvatar(
                                backgroundImage: Image.network(userDoc["photo"])
                                    .image, //LÄGG TILL BASERAT PÅ ANVÄNDARE SEN
                              ),
                            ),
                            Padding(
